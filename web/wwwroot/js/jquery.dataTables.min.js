...
(function (k) {
    ...
    function S(a, b, c, d) {
        ...
        if (l === q)
            return a.iDrawError != e && null === h && (ca(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e), h;
    ...
    function ab(a, b, c, d) {
        ...
        var p = function (x, r) {
            ...
            t = function (x) {
                if (c === q || c === h)
                    g = n[h], l = x.innerHTML.trim(), g && g._bAttrSrc ? (da(g.mData._)(d, l), p(g.mData.sort, x), p(g.mData.type, x), p(g.mData.filter, x)) : m ? (g._setter || (g._setter = da(g.mData)),
                        g._setter(d, l)) : d[h] = l;
                h++
            };
        if (f)
    ...
    function fa(a, b) {
        ...
        if (-1 !== k.inArray(!1, c))
            ...
            if (a.bDeferLoading)
                a.bDeferLoading = !1, a.iDraw++, U(a, !1);
            else if (!l)
                a.iDraw++;
            ...
            if (0 !== n.length)
                ...
                d = g.sZeroRecords, 1 == a.iDraw && "ajax" == P(a) ? d = g.sLoadingRecords : g.sEmptyTable && 0 === a.fnRecordsTotal() && (d = g.sEmptyTable), c[0] = k("<tr/>", {
                    "class": f ? e[0] : ""
                }).append(k("<td />", {
                    valign: "top",
                    colSpan: na(a),
    ...
    function ac(a, b) {
        for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++)
            c = S(a, f, b, "display") + "", c = c.replace(sc,
    ...
    C.extend = function (a, b, c) {
        if (c.length && b && (b instanceof C || b.__dt_wrapper)) {
            ...
            for (d = c.length; f < d; f++) {
                var g = c[f];
                b[g.name] = "function" === g.type ? e(a, g.val, g) : "object" === g.type ? {}
                    : g.val;
        ...
        wc = function (a, b, c) {
            ...
            return ub("row", b,
                function (e) {
                    ...
                    if ("string" === typeof e &&
                        "#" === e.charAt(0) && (f = a.aIds[e.replace(/^#/, "")], f !== q))
                        return [f.idx];
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Ingen data fundet",
            sInfo: "Vis _START_ - _END_ af _TOTAL_",
            sInfoEmpty: "Vis 0 - 0 af 0",
            sInfoFiltered: "(filtreret fra _MAX_ samlede poster)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Vis _MENU_",
            sLoadingRecords: "Indlæser...",
            sProcessing: "Bearbejder...",
            sSearch: "Søg:",
            sSearchPlaceholder: "",
            sUrl: "",
